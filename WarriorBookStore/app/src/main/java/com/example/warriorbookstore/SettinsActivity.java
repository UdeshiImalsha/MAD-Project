    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference dCus = FirebaseDatabase.getInstance().getReference("Users").child(Prevalent.currentOnlineUser.getPhone());
                dCus.removeValue();
                Toast.makeText(SettinsActivity.this, "Profile Deleted", Toast.LENGTH_SHORT).show();
